    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            An e-commerence website is an online platform that facilitates the
            buying and selling of product or services over the internet. it
            serves as a virtual marketplace where businesses and individuals can
            showcase their products, interact with customers, and conduct
            transactions without the need for a physical presence. E-commerence
            website have gained immense popularity due to their convenience,
            accessibility, and the global reach they offer
          </p>
          <p>
            E-commerence websites typically display products or services along
